    ...
    <Modal open={open} onClose={handleClose} title="Import Article">
        ...
        {(["file", "text"] as const).map((t) => (
          <button
            ...
            style={{
              fontFamily:   "var(--font-sans)",
              fontSize:     "var(--text-sm)",
              fontWeight:   tab === t ? "var(--font-semibold)" : "var(--font-regular)",
              color:        tab === t ? "var(--color-accent)" : "var(--color-ink-light)",
      ...
      {tab === "file" && (
        ...
        >
          ...
          <Upload
            size={32}
            style={{ color: "var(--color-ink-faint)", margin: "0 auto var(--space-3)", display: "block" }}
          />
          {file ? (
      ...
      <div style={{ marginBottom: "var(--space-4)" }}>
        <label
          style={{ fontFamily: "var(--font-sans)", fontSize: "var(--text-xs)", color: "var(--color-ink-light)", display: "block", marginBottom: "var(--space-2)" }}
        >
